...
public class StudentProfileController {
  ...
  @Operation(
      summary = "Получить свою карточку",
      description =
          "Доступно только для роли STUDENT. Возвращает полную информацию по текущему студенту.")
  @GetMapping()
  ...
  @Operation(
      ...
      description =
          "Доступно только для роли STUDENT. Позволяет редактировать описание и загрузить новый аватар.")
  ...
  @Operation(
      ...
      description = "STUDENT. Возвращает профиль по авторизации")
  ...
  @Operation(
      ...
      description =
          "Доступно только для роли STUDENT. Позволяет редактировать имя, фамилию и email.")
  ...
  @GetMapping("/mentor")
  @Operation(
      summary = "Получить информацию о менторе студента",
      description = "Доступно для роли STUDENT")
  ...
  @Operation(
      summary = "Прекратить менторство",
      description = "Позволяет студенту отказаться от своего текущего ментора.")
