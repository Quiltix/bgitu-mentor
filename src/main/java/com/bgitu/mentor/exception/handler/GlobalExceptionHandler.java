...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponseDto> handleClientInputExceptions(
    ...
    if (ex instanceof MethodArgumentNotValidException validationEx) {
      ...
      ErrorResponseDto errorResponse =
          new ErrorResponseDto(HttpStatus.BAD_REQUEST, "Ошибка валидации", request, errors);
  ...
  public ResponseEntity<ErrorResponseDto> handleAccessDeniedExceptions(
      Exception ex, WebRequest request) {
    log.warn("Access Denied (403 Forbidden): {}", ex.getMessage());
    ErrorResponseDto errorResponse =
        new ErrorResponseDto(HttpStatus.FORBIDDEN, "Доступ запрещен", request);
  ...
  public ResponseEntity<ErrorResponseDto> handleNotFoundExceptions(
    ...
    ErrorResponseDto errorResponse =
        new ErrorResponseDto(HttpStatus.NOT_FOUND, ex.getMessage(), request);
    return new ResponseEntity<>(errorResponse, HttpStatus.NOT_FOUND);
  }

  // --- 409 Conflict: Ошибки, связанные с конфликтом состояний (например, попытка создать уже
  ...
  public ResponseEntity<ErrorResponseDto> handleConflictExceptions(
    ...
    ErrorResponseDto errorResponse =
        new ErrorResponseDto(HttpStatus.CONFLICT, ex.getMessage(), request);
  ...
  public ResponseEntity<ErrorResponseDto> handleMaxSizeException(
    ...
    ErrorResponseDto errorResponse =
        new ErrorResponseDto(HttpStatus.PAYLOAD_TOO_LARGE, message, request);
  ...
  public ResponseEntity<ErrorResponseDto> handleAllExceptions(Exception ex, WebRequest request) {
    ...
    ErrorResponseDto errorResponse =
        new ErrorResponseDto(HttpStatus.INTERNAL_SERVER_ERROR, message, request);
