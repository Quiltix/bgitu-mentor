...
class MentorProfileServiceImplTest {
    ...
    @Test
    @DisplayName("terminateMentorship | Должен вызвать LifecycleService, если ментор является владельцем студента")
    ...
    @Test
    @DisplayName("terminateMentorship | Должен выбросить SecurityException, если у студента нет ментора")
    void terminateMentorshipWithStudent_shouldThrowSecurityException_whenStudentHasNoMentor(){
        ...
        assertThrows(SecurityException.class,() -> mentorProfileService.terminateMentorshipWithStudent(mentorId,studentId));

        verify(mentorshipLifecycleService,never()).terminateLink(any(),any());
    }

    @Test
    @DisplayName("terminateMentorship | Должен выбросить SecurityException, если у студента другой ментор")
